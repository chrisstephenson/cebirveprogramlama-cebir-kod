...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Oyun) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define (scale-arkaplan bg)
  (if (or (< (image-height bg) 480) (< (image-width bg) 640))
      (scale (max (/ 480 (image-height bg)) (/ 640 (image-width bg))) bg)
      bg))
(define ARKAPLAN (scale-arkaplan (bitmap "Teachpacks/teachpack-images/bg.jpg")))
